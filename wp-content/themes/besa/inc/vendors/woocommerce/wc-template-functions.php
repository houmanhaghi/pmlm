...
if ( !function_exists('besa_tbay_woocommerce_breadcrumb_defaults') ) {
    function besa_tbay_woocommerce_breadcrumb_defaults( $args ) {
        ...
        $args['wrap_before'] = '<section id="tbay-breadscrumb" '.$estyle.' class="tbay-breadscrumb '.esc_attr($breadcrumbs_class).'">'.$img.'<div class="container-fluid"><div class="breadscrumb-inner">'. $title .'<ol class="tbay-woocommerce-breadcrumb breadcrumb">';
