...
if ( ! class_exists( 'Besa_Single_WooCommerce' ) ) :
	...
	class Besa_Single_WooCommerce  {
			...
			if($post){
	          ...
	          $output .= "<div class='". esc_attr( $position ) ."-icon icon-wrapper'>";
	            $output .= "<div class='text'>";
	                ...
	                $output .= ($position == 'left') ? "<a class='img-link left' href=". esc_url($link) .">". esc_html__('Prev', 'besa') . "</a>" :'';                  

	                $output .= ($position == 'right') ? "<a class='img-link right' href=". esc_url($link) .">". esc_html__('Next', 'besa') . "</a>" :'';  
		...
		public function the_total_sales_count() {
		    ...
		    $text = sprintf( '<div class="rate-sold"><span class="sold-text"> 
		    بیش از </span><span class="count">%s</span> خرید این محصول را پیشنهاد کرده اند! <i class="fal fa-badge-check"></i></div>',
